...
int main()
{
	...
	std::deque<studentas> N;//nuskriaustieji
	std::deque<studentas> G;//galvociai
	...
	if (Pasirinkimas == 1)
	{
		...
		Apskaiciuoti_Rezultatus(S, N);
		Rusiuoti_Duomenis(S, N);
		Spausdinti_Rezultatus(S, N);
	}
	...
	if (Pasirinkimas == 5)
	{
		...
		case 5:
			...
			break;
		case 6:
			G_Failo_Vieta = "Studentai100000000.txt";
