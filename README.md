...
Atsisiųskite ir įdiekite „Visual Studio“ ir „CMake“ bei šios programos failus;

Atsivėrę terminalą su komanda cd nueikite į šios programos failų folderį;

Į terminalą įveskite mkdir build;

Į terminalą įveskite cd build;

Į terminalą įveskite cmake -G "Visual Studio 17 2022" .. ( metai priklauso nuo jūsų VS versijos)

Į terminalą įveskite start V2.sln

Atsivėrus Visual Studio atsidarykite "Solution explorer" langelį ir dešiniuoju klavišu paspauskite V2 projekto ir paspauskite "Set as a Startup Project".
